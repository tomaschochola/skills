...
Work from the host by default. Do all edits, filesystem changes, version control and orchestration on the host, including all `devcontainer`, `docker` and `docker compose` invocations.
